...
subject_locator: runxhq/aster#issue/5
...
A `issue-triage` run against `runxhq/aster#issue/5` finished with `success`.
...
Receipt reference: `rx_b862c037844a411fa85fe267377e9b26`.
