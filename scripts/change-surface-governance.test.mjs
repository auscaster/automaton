...
test("classifyRepoPath separates constitutional, learned, and public surfaces", () => {
  ...
  assert.equal(classifyRepoPath("state/targets/nilstate-automaton.md"), "learned_state");
  ...
  assert.equal(classifyRepoPath("scripts/automaton-core.mjs"), "automation_runtime");
